...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        request()->session()->flash('success', 'Đưa Sản phẩm vào Đơn hàng thành công');
    ...
    public function productTrackOrder(Request $request)
    {
        ...
        if ($order) {
            if ($order->status == "new") {
                request()->session()->flash('success', 'Đơn hàng đã đến với cửa hàng, vui lòng đợi phản hồi');
                return redirect()->route('home');
            } elseif ($order->status == "process") {
                request()->session()->flash('success', 'Đơn hàng của bạn đang được xét duyệt.');
                return redirect()->route('home');
            } elseif ($order->status == "delivered") {
                request()->session()->flash('success', 'Đơn hàng của bạn đã được vận chuyển.');
                return redirect()->route('home');
            } else {
