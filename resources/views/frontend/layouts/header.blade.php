                    ...
                    <div class="right-content">
                        ...
                        <li><i class="ti-location-pin"></i> <a href="{{route('order.track')}}">Tra cứu đơn hàng</a></li>
                            ...
                            @auth 
                                ...
                                @else 
                                    <li><i class="ti-user"></i> <a href="{{route('user')}}"  target="_blank">Admin</a></li>
                                @endif
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        ...
                                        <a href="{{route('wishlist')}}">Xem sản phẩm yêu thích</a>
                                    </div>
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="{{Request::path()=='contact' ? 'active' : ''}}"><a href="{{route('contact')}}">Liên lạc với chúng tôi</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
