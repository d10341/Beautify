...
@section('title', 'BEAUTIFY || HOME PAGE')
                                ...
                                <div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            ...
                                            <div class="product-action-2">
                                                <a href="{{ route('add-to-cart', $product->slug) }}">Thêm vào giỏ hàng
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            ...
                            <div class="shop-single-blog">
                                ...
                                <div class="content">
                                    ...
                                    <a href="{{ route('blog.detail', $post->slug) }}" class="more-btn">Tiếp tục
                                        đọc</a>
                                </div>
                            </div>
                            <!-- End Single Blog  -->
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                        ...
                                        @endphp
                                        <h3><small><del
                                                    class="text-muted">₫{{ number_format($product->price, 0) }}</del></small>
                                            ${{ number_format($after_discount, 0) }} </h3>
