...
@section('title', 'BEAUTIFY || Blog Detail page')
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>Tác giả
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group button">
                                                            <button type="submit" class="btn"><span
                                                                    ...
                                                                    class="comment_btn reply" style="display: none;">Trả
                                                                    lời</span></button>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            @else
                                <p class="text-center p-5">
                                    Bạn cần <a href="{{ route('login.form') }}" style="color:rgb(54, 54, 204)">Đăng
                                        nhập</a> hoặc <a style="color:blue" href="{{ route('register.form') }}">Đăng ký</a>
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget newsletter">
                            <h3 class="title">Khách hàng mới?</h3>
                            <div class="letter-inner">
                                <h4>Đăng ký để nhận các ưu đãi<br> và những cập nhật mới nhất về chúng tôi.</h4>
