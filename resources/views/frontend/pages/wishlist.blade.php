							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>Thêm vào giỏ hàngg</a></td>
							...
							@else 
								<tr>
									<td class="text-center">
										Không có sản phẩm yêu thích <a href="{{route('product-grids')}}" style="color:blue;">Thanh toán</a>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service">
						<i class="ti-reload"></i>
						<h4>Hoàn hàng</h4>
						<p>Hõ trợ hoàn hàng trong 30 ngày </p>
					</div>
					<!-- End Single Service -->
				</div>
				<div class="col-lg-3 col-md-6 col-12">
