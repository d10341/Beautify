                                ...
                                <div class="content">
                                    <ul>
                                        <li class="order_subtotal" data-price="{{ Helper::totalCartPrice() }}">Cart
                                            Subtotal<span>₫{{ number_format(Helper::totalCartPrice(), 0) }}</span></li>
                                        <li class="shipping">
                                            Shipping Cost
                                        ...
                                        @if (session('coupon'))
                                            <li class="coupon_price" data-price="{{ session('coupon')['value'] }}">You
                                                Save<span>₫{{ number_format(session('coupon')['value'], 0) }}</span></li>
                                        @endif
                                        @php
                                        ...
                                        @if (session('coupon'))
                                            <li class="last" id="order_total_price">
                                                Total<span>₫{{ number_format($total_amount, 0) }}</span></li>
                                        @else
                                            <li class="last" id="order_total_price">
                                                Total<span>₫{{ number_format($total_amount, 0) }}</span></li>
                                        @endif
