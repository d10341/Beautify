						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4>hi</h4>
									<h3>Nhắn cho chúng tooi nhé @auth @else<span style="font-size:12px;" class="text-danger">[Bạn cần đăng nhập ]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										...
										<div class="col-12">
											<div class="form-group button">
												<button type="submit" class="btn ">Gủi</button>
											</div>
										</div>
									</div>
								</form>
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								<div class="single-info">
									...
									<h4 class="title">Gọi cho chúng tôiw:</h4>
									<ul>
