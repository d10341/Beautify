...
@section('title','BEAUTIFY || Order Track Page')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Tra cứu đươn hàng</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="tracking_box_inner">
            ...
            <form class="row tracking_form my-4" action="{{route('product.track.order')}}" method="post" novalidate="novalidate">
              @csrf
                ...
                <div class="col-md-8 form-group">
                    <button type="submit" value="submit" class="btn submit_btn">Đơn hàng</button>
                </div>
            </form>
        </div>
    </div>
