    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('product.store') }}">
                ...
                <div class="form-group">
                    <label for="summary" class="col-form-label">Đặc điểm <span class="text-danger">*</span></label>
              ...
              @endforeach --}}
                ...
                <div class="form-group">
                    ...
                    <select name="size[]" class="form-control selectpicker" multiple data-live-search="true">
                        ...
                        <option value="Mini">Chiết</option>
                ...
                <div class="form-group">
                    <label for="stock">Ngày sản xuất <span class="text-danger">*</span></label>
